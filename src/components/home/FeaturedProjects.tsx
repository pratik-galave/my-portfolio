...
export default function FeaturedProjects() {
  return (
    <section className="bg-[#050505] pt-24 pb-32" id="projects-preview">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative w-full max-w-5xl mx-auto h-auto md:h-[400px] flex flex-col md:flex-row items-center gap-12 md:gap-0">
          {/* Project Info (Left) */}
          <div className="w-full md:w-1/2 md:pr-12 z-20">
            <h3 className="text-4xl text-gray-500 font-bold mb-6">NUTRIPOCKET</h3>
          ...
          <div className="relative md:absolute right-0 top-0 md:top-1/2 md:-translate-y-1/2 w-full md:w-3/5 h-64 md:h-full z-10 flex items-center justify-center md:justify-end">
            <img
